...
dtype = [int,str,str,int,str,str,float,float,str,str,int,float,float,float,str,
         int,int,int,int,int,int,int,str,str,float,int]
...
#because its a str so there will be errors#
...
get_ipython().system('jupyter nbconvert --ClearOutputPreprocessor.enabled=True     --to python --output=dtools1/__init__.py     Practical-04-Objects.ipynb')
